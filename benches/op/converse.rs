...
fn adjacency_list_add_arc_empty_has_arc_order(
    ...
    bencher.bench(|| {
        drop(converse_adjacency_list_add_arc_empty_has_arc_order(
            &erdos_renyi,
        ));
    });
}
...
fn adjacency_list_btree_set_for_for(bencher: Bencher<'_, '_>, order: usize) {
    ...
    bencher.bench(|| {
        drop(converse_adjacency_list_btree_set_for_for(&erdos_renyi));
    });
}
...
fn adjacency_list_btree_set_fold(bencher: Bencher<'_, '_>, order: usize) {
    ...
    bencher.bench(|| {
        drop(converse_adjacency_list_btree_set_fold(&erdos_renyi));
    });
}
...
fn adjacency_list_weighted_btree_map_for_for(
    ...
    bencher.bench(|| {
        drop(converse_adjacency_list_weighted_btree_map_for_for(
            &erdos_renyi,
        ));
    });
}
...
fn adjacency_list_weighted_btree_map_fold(
    ...
    bencher.bench(|| {
        drop(converse_adjacency_list_weighted_btree_map_fold(
            &erdos_renyi,
        ));
    });
}
...
fn adjacency_map_add_arc_empty_has_arc_order(
    ...
    bencher.bench(|| {
        drop(converse_adjacency_map_add_arc_empty_has_arc_order(
            &erdos_renyi,
        ));
    });
}
...
fn adjacency_map_btree_set_for_for(bencher: Bencher<'_, '_>, order: usize) {
    ...
    bencher.bench(|| {
        drop(converse_adjacency_map_btree_set_for_for(&erdos_renyi));
    });
}
...
fn adjacency_map_btree_set_for_for_vec(
    ...
    bencher.bench(|| {
        drop(converse_adjacency_map_btree_set_for_for_vec(&erdos_renyi));
    });
}
...
fn adjacency_matrix_add_arc_empty_has_arc_order(
    ...
    bencher.bench(|| {
        drop(converse_adjacency_matrix_add_arc_empty_has_arc_order(
            &erdos_renyi,
        ));
    });
}
...
fn edge_list_add_arc_empty_has_arc_order(
    ...
    bencher.bench(|| {
        drop(converse_edge_list_add_arc_empty_has_arc_order(&erdos_renyi));
    });
}
...
fn edge_list_btree_set_collect(bencher: Bencher<'_, '_>, order: usize) {
    ...
    bencher.bench(|| {
        drop(converse_edge_list_btree_set_collect(&erdos_renyi));
    });
}
