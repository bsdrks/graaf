...
//!    * [`bellman_ford_moore`](#bellman_ford_moore)
//!    * [`bfs`](#bfs)
//!    * [`dfs`](#dfs)
//!    * [`dijkstra`](#dijkstra)
//!    * [`floyd_warshall`](#floyd_warshall)
//!    * [`BreadthFirstTree`](#breadthfirsttree)
...
//! types](#types) implement these traits. One can implement these traits for
//! custom digraph types. Operations form the foundation for
//! [algorithms](#algorithms).
//!
//! ## Basic operations
//!
//! [Individual digraph types](#types) implement the basic operations.
//!
...
//!
//! ## [`bellman_ford_moore`](algo::bellman_ford_moore)
//!
//! Bellman-Ford-Moore finds the shortest paths from one source vertex in a
...
//! ## [`bfs`](algo::bfs)
//!
//! Breadth-first search (BFS) explores the vertices of an unweighted digraph in
...
//! ## [`dfs`](algo::dfs)
//!
//! Depth-first search (DFS) explores the vertices of an unweighted digraph in
...
//! * [`dfsa_predecessors`](algo::dfs::dfsa_predecessors) traverses the digraph,
//!   collecting an acyclic ordering, the predecessors of the vertices, and the
//!   times of each vertex's first and last visit.
...
//!
//! ## [`floyd_warshall`](algo::floyd_warshall)
//!
...
//!
//! A breadth-first tree contains the predecessors of the vertices on the
...
//!
//! ## [`DistanceMatrix`](algo::distance_matrix::DistanceMatrix)
//!
...
//! [Adjacency Lists]: `adjacency_list::Digraph`
//! [Adjacency Matrix]: `adjacency_matrix::Digraph`
//! [Adjacency Matrices]: `adjacency_matrix::Digraph`
//! [Weighted Adjacency List]: `adjacency_list_weighted::Digraph`
//! [Weighted Adjacency Lists]: `adjacency_list_weighted::Digraph`
